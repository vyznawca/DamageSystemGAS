...
#include "DS_ShooterPlayerController.generated.h"

class AShooterWeapon;
class UInputMappingContext;
class ADS_PlayerCharacter;
...
class DAMAGESYSTEMGAS_API ADS_ShooterPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<ADS_PlayerCharacter> CharacterClass;
...
protected:
	...
	UFUNCTION()
	void OnWeaponChanged(AShooterWeapon* NewWeapon);
};
