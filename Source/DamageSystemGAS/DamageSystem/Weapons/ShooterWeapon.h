 ...
 */
UCLASS(abstract)
class DAMAGESYSTEMGAS_API AShooterWeapon : public AActor
{
	GENERATED_BODY()
...
public:
	//Damage dealt on hit by projectile
	UPROPERTY(EditDefaultsOnly, Category = "DS|Damage")
	int32 DamagePerHit = 1;
	
	UPROPERTY(EditDefaultsOnly, Category = "DS|Damage")
	int32 HealPerHit = 1;
	
	UPROPERTY(EditDefaultsOnly, Category = "DS|Damage")
	TSubclassOf<UGameplayEffect> SetDamageValueEffect;
