...
int AShooterPickup::GetWeaponDamage() const
{
	if (FWeaponTableRow* WeaponData = WeaponType.GetRow<FWeaponTableRow>("AShooterPickup::GetWeaponDamage()"))
	{
		return WeaponData->WeaponToSpawn->GetDefaultObject<AShooterWeapon>()->DamagePerHit;
	}

	return 1;
}

int AShooterPickup::GetWeaponHeal() const
{
	if (FWeaponTableRow* WeaponData = WeaponType.GetRow<FWeaponTableRow>("AShooterPickup::GetWeaponDamage()"))
	{
		return WeaponData->WeaponToSpawn->GetDefaultObject<AShooterWeapon>()->HealPerHit;
	}
