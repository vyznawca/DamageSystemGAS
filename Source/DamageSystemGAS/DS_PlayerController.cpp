...
#include "Characters/DS_PlayerCameraManager.h"
#include "Widgets/Input/SVirtualJoystick.h"

ADS_PlayerController::ADS_PlayerController()
{
	// set the player camera manager class
	PlayerCameraManagerClass = ADS_PlayerCameraManager::StaticClass();
}
...
bool ADS_PlayerController::ShouldUseTouchControls() const
{
